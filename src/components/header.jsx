  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-gradient-to-b from-gray-900 to-gray-800 text-white py-4 z-50">
      <nav className="container mx-auto px-6 md:px-24 flex justify-between items-center">
        ...
        {/* Navigation */}
        <ul
          className={`absolute md:static top-20 left-0 w-full md:w-auto bg-gradient-to-b from-gray-900 to-gray-800 md:bg-none flex-col md:flex-row text-[18px] md:text-[20px] font-medium flex md:flex space-y-4 md:space-y-0 md:space-x-12 items-start md:items-center pl-12 pr-6 md:px-0 transition-all duration-300 ${
