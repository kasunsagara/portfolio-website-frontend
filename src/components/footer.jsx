    ...
    <footer className="bg-gradient-to-b from-gray-900 to-gray-800 text-white py-10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left space-y-6 md:space-y-0">
          ...
          <div className="flex flex-col items-center md:items-start mb-4 md:mb-0 max-w-full md:max-w-xs">
            <h1 className="text-2xl font-semibold text-[#00ffff] mb-2">Kasun Sagara</h1>
            <p className="max-w-full md:max-w-md px-2 md:px-0">
        ...
        <div className="flex justify-center px-4">
          <p className="text-center text-base font-medium tracking-wide max-w-full md:max-w-3xl">
