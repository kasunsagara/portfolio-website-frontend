...
export default function Contact() {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      data.append("access_key", "ba65b4b3-038d-4815-bf10-723d3b924f0d"); // <-- Add your Access Key
    ...
    <section id="contact" className="min-h-screen py-20 bg-gradient-to-br from-gray-900 to-black text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          {/* ★ Contact Form */}
          <motion.div variants={formVariants} initial="hidden" whileInView="visible" viewport={{ once: true }} className="relative">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-gray-700/50 border border-gray-600 rounded-xl pl-12 pr-4 py-4 text-white"
                  />
                </motion.div>
                ...
                <motion.div className="relative">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    required
                    className="w-full bg-gray-700/50 border border-gray-600 rounded-xl pl-12 pr-4 py-4 text-white resize-none"
                  />
                </motion.div>
                ...
                >
                  <AnimatePresence mode="wait">
                    {loading ? (
                      ...
                      <motion.div key="success" className="text-green-400">✓</motion.div>
                    ) : (
                      <motion.div key="send" className="flex items-center space-x-2">
          ...
          {/* ★ Contact Info Cards */}
          <motion.div variants={infoVariants} initial="hidden" whileInView="visible" className="space-y-6">
                ...
                >
                  ...
                  <div className="relative bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-6 group-hover:border-cyan-400/50 transition-all duration-300">
                    <div className="flex items-center space-x-4">
                      <motion.div className={`p-4 bg-gradient-to-br ${info.color} rounded-2xl`}>
                        <info.icon className="text-2xl text-white" />
                      </motion.div>
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-white group-hover:text-cyan-400">{info.title}</h3>
