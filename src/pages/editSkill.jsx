...
import { FaSave, FaCode, FaTag, FaFileAlt, FaArrowLeft, FaLaptopCode, FaServer, FaDatabase, FaTools, FaThLarge, FaMagic } from 'react-icons/fa';
...
export default function EditSkill() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(import.meta.env.VITE_BACKEND_URL + `/api/skills/${id}`, formData);
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        ...
        >
          ...
          <p className="text-gray-400">Loading skill data...</p>
        </motion.div>
      </div>
    );
  }
      ...
      >
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-400">Update your technical skill details</p>
          </div>
        </div>
      </motion.div>
