...
import { FaSave, FaCode, FaHeading, FaFileAlt, FaArrowLeft, FaHandshake, FaMagic } from 'react-icons/fa';
...
export default function EditService() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(import.meta.env.VITE_BACKEND_URL + `/api/services/${id}`, formData);
      ...
      >
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-400">Update your service details</p>
          </div>
        </div>
      </motion.div>
